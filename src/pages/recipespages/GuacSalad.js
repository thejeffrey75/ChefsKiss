import guacsalad from "../assets/brooke-lark-oaz0raysASk-unsplash.jpg"
import "./GuacSalad.css"


export function GuacSalad(){
    return(<div>

        <div className="guacsaladgrid">
         <div className='div1'>
         <h1>Avacado Sem
        </h1>
            <img className='recipeimage'src={guacsalad} alt='guac salad' />
