...
import chickensandwich from "../assets/eaters-collective-pLKgCsBOiw4-unsplash.jpg"

export function ChickenSandwich(){
    return(<div>

        <div className="chickengrid">
         <div className='div1'>
         <h1>Sandwich Gallinaceus
        </h1>
            <img className='recipeimage'src={chickensandwich} alt='chickensandwich' />
