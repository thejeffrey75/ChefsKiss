...
import wonton from "../assets/charlesdeluvio-D-vDQMTfAAU-unsplash.jpg"

export function Wonton(){
    return(<div>

        <div className="saladgrid">
         <div className='div1'>
         <h1>Wonton
        </h1>
            <img className='recipeimage'src={wonton} alt='wonton' />
